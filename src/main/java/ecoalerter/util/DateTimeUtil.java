 ...
 *
 * Klasa dostarcza zestaw predefiniowanych formaterów zgodnych z formatami
 * używanymi przez API IMGW-PIB oraz na potrzeby wewnętrzne aplikacji
 * (wyświetlanie w GUI, zapis do pliku, zapis do bazy danych).
 *
 * Wszystkie metody są statyczne i bezpieczne wątkowo —
...
public final class DateTimeUtil {
    ...
    /**
     * Format do zapisu w bazie danych i plikach JSON/CSV.
    ...
    */
     ...
     * i plikach JSON/CSV (format {@link #DB_FORMAT}).
     *
    ...
    */
     ...
     *
     * Obsługiwane formaty (w kolejności prób):
