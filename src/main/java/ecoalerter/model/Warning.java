...
public class Warning {
    ...
    */
    ...
    /** Pełna treść komunikatu ostrzeżenia składana przez {@code WarningApiService}. */
    ...
    */
    public Warning(String id, WarningLevel level, StationType type,
                   String phenomenon, LocalDateTime issuedAt, LocalDateTime validUntil) {
        this.id          = id;
        this.level       = level;
        this.type        = type;
    ...
    */
    ...
    public String toString() {
        return String.format(
                "Warning{id='%s', level=%s, type=%s, phenomenon='%s', active=%b, validUntil=%s}",
                id, level, type, phenomenon, isActive(), validUntil);
    }
    ...
    /** @return treść komunikatu ostrzeżenia */
